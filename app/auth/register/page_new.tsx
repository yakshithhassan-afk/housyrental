...
import { Mail, Lock, User, Eye, EyeOff, Building2, CheckCircle, ArrowRight } from "lucide-react";
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`relative p-4 rounded-2xl text-center transition-all duration-300 transform hover:scale-105 ${
                    role === "USER"
                      ? "bg-gradient-to-br from-cyan-600 to-teal-600 text-white shadow-xl scale-105"
                      : "border-2 border-gray-200 hover:border-cyan-300 bg-white text-gray-700 hover:shadow-md"
                  }`}
                >
                  {role === "USER" && (
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-center text-white">
            ...
            <h2 className="text-4xl font-bold mb-4">Welcome to HousyRental</h2>
            <p className="text-xl text-cyan-100 mb-8">Your trusted platform for finding and managing rental properties</p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-cyan-100">Find your dream home easily</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-cyan-100">Manage and rent your properties</p>
                </div>
              </div>
            </div>
          </div>
